...
<div class="bg-white rounded-[2rem] shadow-sm border border-slate-200 overflow-hidden">
    <div class="p-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
        <div>
            ...
            <p class="text-xs text-slate-500 uppercase font-black tracking-widest mt-2">Buat halaman kustom baru</p>
        </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm">
                        ...
                        <p class="text-[9px] text-slate-400 font-medium mt-4 leading-relaxed">
                            Pilih hashtag yang relevan dengan konten halaman ini.
                        </p>
                    </div>
                    ...
                    <div class="bg-[#080c18] p-8 rounded-[2rem] shadow-xl shadow-slate-900/20 text-white">
                        ...
                        <p class="text-xs text-slate-400 mb-8 leading-relaxed">
                            Pastikan konten, slug, SEO, dan hashtag sudah sesuai.
                        </p>
